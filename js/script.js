   ...
   setTimeout(
    ...
    var a = Math.floor((Math.random()*(questions.length))),
     ...
     if (n > 10) {   
      ...
      document.getElementById("song").pause();
      $("body").append(p.g, p.d);
      if (s == 0) {$("#finalScore").text(100)} else {
